...
export class ContentStripMultipleComponent extends WidgetBaseComponent
  ...
  filterCourse(contents: any) {
    ...
    const negativeList = [
      ...
      'do_1136945911089315841314',
      'do_1136782979878830081208',
      'do_1137080467819233281337',
      'do_1137277157194874881840',
      'do_1137271380816445441783',
      'do_11372920869709414411055',
      'do_11372920673603584011054',
      'do_11372936540887449611133',
      'do_11372936199061504011127',
      'do_11373908855994777612314',
      'do_11373906402920857612296',
      'do_11373852727316480012245',
      'do_11373918807187456012336',
      'do_11373921762573516812362',
      'do_11373975656020377612518',
      'do_11373985951141888012558',
      'do_11373988145184768012597',
      'do_1137448329381806081491',
      'do_1137448557243269121527',
      'do_1137448958008442881622',
      'do_1137447196144107521311',
      'do_1137447317471805441329',
      'do_1137447179863408641305',
      'do_1137449172762378241657',
      'do_1137448685303152641574',
      'do_1137449159525662721654',
      'do_1137447259157135361320',
      'do_1137447937996226561435',
      'do_1137447317471805441329',
      'do_1137449172762378241657',
      'do_1137448685303152641574',
      'do_1137449159525662721654',
    ...
    const newList = list.filter((i: any) => {
      return (i.identifier !== 'do_11357408383009587211503' && i.identifier !== 'do_1136945911089315841314' && i.identifier !== 'do_1136782979878830081208' && i.identifier !== 'do_1137277157194874881840' && i.identifier !== 'do_1137271380816445441783' && i.identifier !== 'do_11372920869709414411055' && i.identifier !== 'do_11372920673603584011054' && i.identifier !== 'do_11372936540887449611133' && i.identifier !== 'do_11372936199061504011127' && i.identifier !== 'do_11373908855994777612314' && i.identifier != 'do_11373906402920857612296' && i.identifier != 'do_11373852727316480012245' && i.identifier != 'do_11357408383009587211503')
    })
